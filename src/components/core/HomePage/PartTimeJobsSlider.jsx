  ...
  useEffect(() => {
    ...
    const fetchJobs = async () => {
      try {
        ...
        console.log("PART TIME JOBS SLIDER :",response);
        setJobs(response);
      } catch (error) {
        console.error('Error fetching part time jobs in slider:', error.message);
      }
    };
    fetchJobs();
  }, []);
...
export default PartTimeJobsSlider;